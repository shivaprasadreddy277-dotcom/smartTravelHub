...
function Collections({ onExplore }) {
  ...
  return (
    <div className="collections-page">
      ...
      <div className="collections-tabs">
        <button
          type="button"
          className={`collections-tab ${activeTab === 'trending' ? 'active' : ''}`}
        ...
        <button
          type="button"
          className={`collections-tab ${activeTab === 'hidden' ? 'active' : ''}`}
